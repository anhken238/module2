...
public class CustomerController {
    ...
    public String saveEdit(Customer customer, RedirectAttributes redirect){
        customerService.update(customer.getId(), customer);
        redirect.addFlashAttribute("success", "save edit success");
        return "redirect:/home";
    }
    ...
    public String saveDelete(Customer customer, RedirectAttributes redirect){
        customerService.remove(customer.getId());
        redirect.addFlashAttribute("success", "delete was success");
        return "redirect:/home";
